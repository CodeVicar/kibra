const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/KibraBoxingClub/",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/kibraboxingclub",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "X",
      href: "https://twitter.com/KibraBoxingClub",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className=" md:flex  justify-between">
          ...
          <div className="mt-10 md:mt-0">
            <h3 className="text-sm font-bold leading-6 text-gray-100 underline">
              Links
            </h3>
            <ul role="list" className="mt-6 space-y-4">
              {navigation.solutions.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    className="text-sm leading-6 text-gray-100 hover:text-gray-100"
                  >
                    {item.name}
                  </a>
                </li>
